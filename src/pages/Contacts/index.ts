...
export * from './components/Leads/columnsTable/lastOrigin';
export * from './components/Leads/columnsTable/name';
export * from './components/Leads/columnsTable/totalValue';
